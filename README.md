...
- **2026-09-04** · Envelope 020 · [PR #117](https://github.com/bywale-com/travis/pull/117) — Travis gets a box: Linux VM API, server-side key, disk; SA ascribes the port, because Tasklet-shaped recovery needs a machine and Vercel plus Cursor seats are not that machine.
...
- **2026-09-04** · Hotfix 066 · [PR #109](https://github.com/bywale-com/travis/pull/109) — House protocols and leftover pickup files name one PR, and 003–007 land on `main`, because the law lived in one folder while seats still fetched cousin drafts.
...
- **2026-09-02** · Hotfix 040 · [PR #55](https://github.com/bywale-com/travis/pull/55) — Safe is now a written definition with tool classes, a fail-closed registry and asserted coverage, because every contract we had lived in a paragraph of English that nothing enforced.
