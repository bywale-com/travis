...
- **2026-09-04** · Envelope 022 · (PR after open) — Ports become a control and Travis fills the harness, because another `TRAVIS_*` token is the hardcoded path and I1 is still Cursor chrome.
