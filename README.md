...
- **2026-09-02** · Hotfix 041 · [PR #54](https://github.com/bywale-com/travis/pull/54) — Travis writes one plain line saying what it is about to do before each tool runs, because Type sat blank for thirty seconds while Voice narrated itself and only one of them felt intelligent.
- **2026-09-02** · Hotfix 040 · [PR #54](https://github.com/bywale-com/travis/pull/54) — Safe is now a written definition with tool classes, a fail-closed registry and asserted coverage, because every contract we had lived in a paragraph of English that nothing enforced.
