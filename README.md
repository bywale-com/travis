...
- **2026-09-04** · Envelope 020 · this PR — Travis gets a box: Linux VM API, server-side key, disk; SA ascribes the port, because Tasklet-shaped recovery needs a machine and Vercel plus Cursor seats are not that machine.
