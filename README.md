...
- **2026-09-05** · Hotfix 073 · Technical PM — The PM inspects `src/` and specs the face and the cut, and the Engineer only implements what PM and SA already specced, because the founder locked the seat as a technical PM on top of vision and the log.
