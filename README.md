...
- **2026-09-02** · Hotfix 039 · [PR #54](https://github.com/bywale-com/travis/pull/54) — Travis can start a seat and keep talking instead of freezing until the run ends, because every send held its request open, which made fan-out serial and kept the queue permanently empty.
