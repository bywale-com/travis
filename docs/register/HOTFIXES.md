...
| Next | Always `max(existing NNN) + 1`. **Never reuse** a number. Next: **051**. |
...
| 050 | [`HOTFIX-050-ONE-OR-TWO.md`](./HOTFIX-050-ONE-OR-TWO.md) | One seat per beat, two at most; same ask to a second seat is refused |
