...
| Next | Always `max(existing NNN) + 1`. **Never reuse** a number. Next: **028**. |
...
| 027 | [`HOTFIX-027-TRAVIS-STATUS.md`](./HOTFIX-027-TRAVIS-STATUS.md) | Show status turns — Travis failures were filtered out of the log |
