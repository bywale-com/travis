...
| Next | Always `max(existing NNN) + 1`. **Never reuse** a number. Next: **073**. |
...
| # | File | Cut |
|---|------|-----|
| 072 | [`HOTFIX-072-PM-REBIND.md`](./HOTFIX-072-PM-REBIND.md) | Deprecate Pm ID provision; bind PM to the new chat |
