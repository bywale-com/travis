# New — what is queued to report

**Kind:** Two plates. Engineer, founder-asked. Not a PM packet. Does not append the PM or SA logs.  
**When:** 2026-09-03  
**Plates:** [`travis-n1-voice-new-mission.png`](./plates/travis-n1-voice-new-mission.png) · [`travis-n2-log-new-mission.png`](./plates/travis-n2-log-new-mission.png)  
**Sits on:** PM-PACKET-007 hear-queue (locked). Founder word here is **New**, not `ready`.  
**Not 003.** `waiting` is still *your* line on a busy seat.
...
- Do not reuse the 003 word `waiting`.
